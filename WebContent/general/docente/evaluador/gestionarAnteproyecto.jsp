...
<body>
    ...
    <div class="container mt-5">
        <h2>Gestionar Anteproyectos como Evaluador</h2>
        ...
        <!-- Consulta para obtener los proyectos donde el usuario logueado es evaluador -->
        <sql:query var="proyectosEvaluador" dataSource="${ds}">
            SELECT id, titulo 
            FROM proyecto 
            WHERE id_evaluador = ?;
        ...
        <!-- Tabla para mostrar los proyectos en los que el usuario es evaluador -->
        <table class="table table-bordered mt-3">
            ...
            <tbody>
                <c:forEach var="proyecto" items="${proyectosEvaluador.rows}">
                    <tr>
                        <td>${proyecto.id}</td>
        ...
        <!-- Mensaje si no hay proyectos disponibles como evaluador -->
        <c:if test="${empty proyectosEvaluador.rows}">
            <div class="alert alert-warning mt-3">No hay proyectos disponibles para gestionar como Evaluador.</div>
        </c:if>
    </div>
</body>
</html>
