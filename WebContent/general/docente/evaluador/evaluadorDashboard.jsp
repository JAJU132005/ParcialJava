...
<body>
    <div class="button-containerE">
        <button class="button" onclick="window.location.href='../docenteDashboard.jsp'">Salir</button>
    </div>
    <div class="container">
        <h1>Menu de evaluador</h1>
        <p>Bienvenido, ${sessionScope.userNombre}</p>
        <p>Tu ID es: ${sessionScope.userId}</p>
        <div class="button-container">
            <button class="button" onclick="window.location.href='gestionarAnteproyecto.jsp'">Gestionar Anteproyecto</button>
