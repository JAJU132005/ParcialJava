...
<body>
    ...
    <div class="container">
        <h1>Menu de docente</h1>
        <p>Bienvenido, ${sessionScope.userNombre}</p>
        <p>Tu ID es: ${sessionScope.userId}</p>
        <div class="button-container">
            <button class="button" onclick="window.location.href='evaluador/evaluadorDashboard.jsp'">Menu de Evaluador</button>
            <button class="button" onclick="window.location.href='director/directorDashboard.jsp'">Menu de Director</button>
        </div>
    </div>
</body>
</html>
