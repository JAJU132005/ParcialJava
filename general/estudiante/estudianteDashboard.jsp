...
<body>
    ...
    <div class="container">
        <h1>Menu de Estudiante</h1>
        <p>Bienvenido, ${sessionScope.userNombre}</p>
        <p>Tu ID es: ${sessionScope.userId}</p>
        <div class="button-container">
            <button class="button" onclick="window.location.href='seleccionarIdeaAnteproyecto.jsp'">Seleccionar idea Anteproyecto</button>
            <button class="button" onclick="window.location.href='gestionarIdeaAnteproyecto.jsp'">Gestionar Anteproyecto</button>
