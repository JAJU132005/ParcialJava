...
<body>
    ...
    <div class="container mt-5">
        ...
        <!-- Consulta para obtener los proyectos con estado_idea = 1 y del coordinador logueado -->
            ...
            <tbody>
                <c:forEach var="proyecto" items="${proyectos.rows}">
                    <tr>
                        ...
                        <td>
                            <!-- Botón para gestionar el proyecto, redirige a gestionarDetalleProyecto.jsp -->
        ...
        <c:if test="${empty proyectos.rows}">
            <div class="alert alert-warning mt-3">No hay proyectos disponibles para gestionar.</div>
        </c:if>
    </div>
</body>
</html>
